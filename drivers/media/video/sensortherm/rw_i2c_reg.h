...
#define CAMERA_ENOERR 		0x00 	//No error - command was successful
#define CAMERA_ENOENT 		0x01 	//No such entity
#define CAMERA_EINTR 		0x02 	//Operation interrupted
#define CAMERA_EIO 		0x03 	//I/O failure
#define CAMERA_E2BIG 		0x04 	//Too big
#define CAMERA_EBADF 		0x05 	//Bad file/handle
#define CAMERA_EAGAIN 		0x06 	//Would-block, try again
#define CAMERA_ENOMEM 		0x07 	//Not enough memory/resource
#define CAMERA_EACCES 		0x08 	//Permission denied
#define CAMERA_EBUSY 		0x09 	//Entity busy, cannot support operation
#define CAMERA_EEXIST 		0x0A 	//Entity exists
#define CAMERA_ENODEV 		0x0B 	//Device not found
#define CAMERA_EINVAL 		0x0C 	//Invalid argument
#define CAMERA_ENOSPC 		0x0D 	//No space/resource to complete
#define CAMERA_ERANGE 		0x0E 	//Parameter out of range
#define CAMERA_ENOSYS 		0x0F 	//Operation not supported
#define CAMERA_EALREADY 	0x10 	//Already requested/exists
...
/**
 * struct register_value - Structure for register initialization values

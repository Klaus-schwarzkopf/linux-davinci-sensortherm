...
//		write_regs(client,reg_list_enable_overlay);
//		write_regs(client,reg_list_image_to_buffer0);
//		write_regs(client,reg_list_buffer0_to_layer0);
//		write_regs(client,reg_list_analog_on);
//
//
//		reg_write(client, 0x098E, 0x7C00);
//		reg_write(client,0xFC00, 0x0001);
//		reg_write(client,0xFC02, 0x0000);
//		reg_write(client,0xFC04, 0x00C8);
//		reg_write(client,0x0040, 0x8203);
//
//
//		reg_write(client,0x098E, 0x7C00);
//		reg_write(client,0xFC00, 0x0000);
